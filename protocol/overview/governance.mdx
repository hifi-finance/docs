...
We selected Uniswap for our token implementation as it includes ERC-2612 functionality and the governance-based minting feature we need. Uniswap's token implementation code is a direct fork of the Compound token implementation.

Our governance contracts are built on the Ampleforth fork of GovernorBravo, primarily because, like Hifi and unlike Uniswap or Compound, they did not possess legacy GovernorAlpha smart contracts prior to their GovernorBravo implementation.
