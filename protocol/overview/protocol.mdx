...
Protocol](https://yield.is/Yield.pdf) paper. The protocol is implemented in a system
...
fractional quantities with sufficient precision. We need this library especially in the
