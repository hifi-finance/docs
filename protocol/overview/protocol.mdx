...
All contracts have their source code verified on Etherscan and Polygonscan.

## Licensing

The smart contracts in the
[protocol](https://github.com/hifi-finance/hifi/tree/%40hifi/protocol%401.9.0/packages/protocol) and the
[amm](https://github.com/hifi-finance/hifi/tree/%40hifi/amm%401.9.1/packages/amm) packages are released under the
[BUSL-1.1](https://github.com/hifi-finance/hifi/blob/7ea0664879e2f122306369d1fc3206c94bf1cbeb/LICENSE.md) license. The
