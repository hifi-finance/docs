...
<YouTubeEmbed embedId="5NU6dIAoJyE" />

---

To provide liquidity, access the "Pool" tab in the [Hifi Interface](https://app.hifi.finance/pool).

1. Ensure you have ported over your assets from Ethereum to the Polygon network.
2. Head over to the "Pool" tab and select the market you want to provide liquidity to.
3. Input the amount of liquidity you would like to provide and choose your pooling strategy.

:::tip
"Buy & pool" is typically best for small amounts of money. "Borrow & pool" works better for larger amounts.
:::

4. Hit "Add liquidity" and confirm the transaction in your wallet.

:::info
Being a liquidity provider gives you a portion of the fees paid on every single trade that occurs in this particular
market. Adding liquidity to the Hifi markets is a great way to put your idle capital at work, since the risk of
impermanent loss is low.
:::

To improve the liquidity of hTokens, Hifi has implemented a custom liquidity provider designed to enable efficient
trading between hTokens and their underlying assets. You can read more about this design in the [Yield
Space](https://yield.is/YieldSpace.pdf) whitepaper to get a deeper understanding of the calculations and the overall
mechanism. The Hifi Interface integrates the AMM seamlessly into the user experience.
...
Similar to Uniswap v2, providing liquidity to YieldSpace will grant you Liquidity Provider shares. If you are providing
liquidity for hUSDCMar22, you get hUSDCMar22LP tokens which represent your share of the pool. These tokens are ERC-20
tokens and may further be composed in the DeFi ecosystem.
