...
Hifi is deployed on Ethereum Mainnet, as documented in the previous section [Network
Addresses](./network-addresses.md). We are maintaining a subgraph for each network:

| Network          | Link                                                           |
| ---------------- | -------------------------------------------------------------- |
| Ethereum Mainnet | https://thegraph.com/explorer/subgraphs/ANAXtqRM9cUySpQZ8xuaFTdu1oFCj4HYaRXXiChTihAM |
